...
class UsuariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create usuario" do
    assert_difference('Usuario.count') do
      post usuarios_url, params: { usuario: { first_name: @usuario.first_name, last_name: @usuario.last_name } }
    end
  ...
  test "should update usuario" do
    patch usuario_url(@usuario), params: { usuario: { first_name: @usuario.first_name, last_name: @usuario.last_name } }
